                ...
                <section class="wrapper">
                    <div class="heading" v-if="isLogin">
                        ...
                        <p class="text text-normal">New user? <span><a class="text text-links"
                                    @click="redirect.register()">Create an account</a></span>
                        </p>
                    </div>
                    ...
                    <div name="signin" class="form">
                        ...
                        <div>
                            <div class="input-control" v-if="isLogin">
                                <button @click="login()" class="input-submit">Login</button>
                            </div>
                        </div>

                        <div>
                            <div class="input-control" v-if="!isLogin">
                                <button @click="register()" class="input-submit">Register</button>
                            </div>
                        </div>
                    </div>
                </section>
